...
export type LoadDataType = (loadMore?: boolean, refresh?: boolean) => ReturnType<typeof action>;

export type LoadDataSingleType = (loadMore: boolean, refresh: boolean, url: string) => ReturnType<typeof action>;

export type LoadBibleChaptersType = (loadMore: boolean, refresh: boolean, book: {}) => ReturnType<typeof action>;

export type LoadBookType = (loadMore: boolean, refresh: boolean, url: string, id: string) => ReturnType<typeof action>;

export const loadBibleBooks: LoadDataType = (loadMore, refresh) => action(LOAD_BIBLE_BOOKS, { loadMore, refresh });
export const loadBibleChapters: LoadBibleChaptersType = (loadMore, refresh, book) =>
	action(LOAD_BIBLE_CHAPTERS, { loadMore, refresh, book });
export const loadBibleVerses = () => action(LOAD_BIBLE_VERSES);
export const loadNewRecordings: LoadDataType = (loadMore, refresh) =>
	action(LOAD_NEW_RECORDINGS, { loadMore, refresh });
export const loadTrendingRecordings: LoadDataType = (loadMore, refresh) =>
	action(LOAD_TRENDING_RECORDINGS, { loadMore, refresh });
export const loadFeaturedRecordings: LoadDataType = (loadMore, refresh) =>
	action(LOAD_FEATURED_RECORDINGS, { loadMore, refresh });
...
export const loadPresenter: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_PRESENTER, { loadMore, refresh, url });
export const loadConferences: LoadDataType = (loadMore, refresh) => action(LOAD_CONFERENCES, { loadMore, refresh });
export const loadConference: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_CONFERENCE, { loadMore, refresh, url });
export const loadSponsors: LoadDataType = (loadMore, refresh) => action(LOAD_SPONSORS, { loadMore, refresh });
export const loadSponsor: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_SPONSOR, { loadMore, refresh, url });
...
export const loadTagBook: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_TAG_BOOK, { loadMore, refresh, url });
export const loadTagsAlbums: LoadDataType = (loadMore, refresh) => action(LOAD_TAGS_ALBUMS, { loadMore, refresh });
export const loadTagAlbum: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_TAG_ALBUM, { loadMore, refresh, url });
export const loadTagsSponsors: LoadDataType = (loadMore, refresh) => action(LOAD_TAGS_SPONSORS, { loadMore, refresh });
export const loadTagSponsor: LoadDataSingleType = (loadMore, refresh, url) =>
	action(LOAD_TAG_SPONSOR, { loadMore, refresh, url });
...
export const resetAndPlayTrack = (tracks: {}[], id: string | null = null) =>
	action(RESET_AND_PLAY_TRACK, { tracks, id });
...
export const download = (
	...
	bitRate: string,
	cb?: () => {}
) => action(DOWNLOAD, { item, downloadPath, downloadUrl, fileName, bitRate, cb });
