...
const Settings: React.FC<Props> = ({ navigation, language, bitRate, autoPlay, user, actions }) => {
	const showLanguages = () => {
	...
	const handleLoginLogout = () => {
		if (user) {
			Alert.alert(I18n.t('Are_you_sure'), '', [
				{
					text: I18n.t('Cancel'),
					onPress: () => {
						//
		...
		<View style={styles.container}>
			<View>
				...
				<ListItem
					...
					rightElement={<Switch value={autoPlay} onValueChange={setAutoPlay} />}
					bottomDivider
					onPress={showLanguages}
				/>
				<ListItem
