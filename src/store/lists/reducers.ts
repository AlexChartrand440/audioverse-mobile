...
export function listsReducer(state = initialState, action: ListsActionTypes): ListsState {
	switch (action.type) {
		// Downloads
		case DOWNLOADS_SET:
			return {
		...
		case DOWNLOADS_ADD:
			return {
				...state,
				downloads: [...state.downloads, ...action.items],
			};
		...
		case FAVORITES_ADD:
			return {
				...state,
				favorites: [...state.favorites, ...action.items],
			};
		...
		case PLAYLISTS_ADD:
			return {
				...state,
				playlists: [...state.playlists, ...action.items],
			};
		...
		case PLAYLISTS_ITEMS_ADD:
			return {
				...state,
				playlistsItems: [...state.playlistsItems, ...action.items],
			};
